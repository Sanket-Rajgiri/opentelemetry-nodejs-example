...
const dbUrl = process.env.DATABASE_URL || "mongodb://mongodb:27017/users";
const honoappUrl = process.env.HONOAPP_URL || "http://hono-app:3000";
...
app.get('/external/users', async (c) => {
  const externalUrl = `${honoappUrl}/users`;
  try {
